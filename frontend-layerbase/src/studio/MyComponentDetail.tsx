        ...
        >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3 font-mono text-xs text-muted">
            ...
            {component.tags?.map((tag) => (
              <span key={tag.id} className="rounded-pill bg-navy-50 px-2 py-0.5 text-navy">
                {tag.name}
              </span>
            ))}
          </div>
...
function Metric({
  ...
  return (
    <div className="rounded-lg border border-border bg-surface p-5 transition hover:border-navy-200 hover:shadow-hover">
